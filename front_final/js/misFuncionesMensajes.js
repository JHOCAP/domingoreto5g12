function autoInicioRelacionCliente(){
    ...
    $.ajax({
        url:"http://150.230.93.107:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
...
function autoInicioMensajes(){
    ...
    $.ajax({
        url:"http://150.230.93.107:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function pintarRespuestaMensajes(respuesta){
    ...
    for(i=0;i<respuesta.length;i++){
        ...
        myTable+="<td>"+respuesta[i].Audience.name+"</td>";
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        url:"http://150.230.93.107.186:8080/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
        url:"http://150.230.93.107:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        url:"http://150.230.93.107:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
